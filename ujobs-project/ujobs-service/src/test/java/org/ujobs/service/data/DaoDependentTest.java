...
public abstract class DaoDependentTest {
	...
	@BeforeClass
	public static void initializeEmbeddedMongo() throws UnknownHostException,
			IOException {
		int port = 12345;
	...
	public Dao<Tag, ObjectId> getTagDao() {
		TypeLiteral<Tag> mapType = new TypeLiteral<Tag>() {
		};
		return new Dao<Tag, ObjectId>(mapType, mongo, morphia, TEST_DB_NAME);
	}
	
	public UserService getUserService() {
		UserService userService = new UserServiceImpl(this.getUserDao(),getAbilityService());
		return userService;
	}
	
	public TagService getAbilityService() {
		TagService abilityService = new TagServiceImpl(this.getTagDao());
